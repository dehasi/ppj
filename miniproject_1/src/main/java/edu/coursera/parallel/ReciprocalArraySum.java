...
public final class ReciprocalArraySum {
     ...
     */
    private static class ReciprocalArraySumTask extends RecursiveAction implements Callable<Void> {

        static int THRESTHOLD = 10000;
        /**
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        // probably it makes sense to play with the threshold
