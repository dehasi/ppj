...
public class MatrixMult {
    ...
    public static void parallelMatrixMultiply(Matrix a, Matrix b, Matrix c,
        ...
        final int startRow = rowChunk * myrank;
        int endRow = startRow + rowChunk;
        ...
        if (myrank == 0) {
            ...
            for (int i = 1; i < size; i++) {
                ...
                int offset = rankStartRow * c.getNCols();
                int nElements = (rankEndRow - rankStartRow) * c.getNCols();
                requests[i - 1] = mpi.MPI_Irecv(c.getValues(), offset, nElements, i, i, mpi.MPI_COMM_WORLD);
            }
